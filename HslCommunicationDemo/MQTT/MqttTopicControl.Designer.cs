namespace HslCommunicationDemo.MQTT
{
	partial class MqttTopicControl
	{
		...
		private void InitializeComponent( )
		{
			...
			this.label_topic_interval = new System.Windows.Forms.Label();
			...
			this.panel2.Controls.Add(this.label_topic_interval);
			...
			// 
			// label_topic_interval
			// 
			this.label_topic_interval.AutoSize = true;
			this.label_topic_interval.ForeColor = System.Drawing.Color.Gray;
			this.label_topic_interval.Location = new System.Drawing.Point(4, 158);
			this.label_topic_interval.Name = "label_topic_interval";
			this.label_topic_interval.Size = new System.Drawing.Size(13, 17);
			this.label_topic_interval.TabIndex = 29;
			this.label_topic_interval.Text = "-";
			// 
			// label3
			// 
		...
		private System.Windows.Forms.Label label_topic_interval;
	}
}
